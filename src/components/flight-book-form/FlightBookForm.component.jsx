          ...
          <div className="gap">
            <div className="container cm-txt-center">
              ...
              <p>
                ...
                Flighttripcharge, and we want you to know that our team is already at
                      ...
                      <div className="travel-protection-block">
                        ...
                        <div className="">
                          ...
                          <div>
                            ...
                            <a href="mailto:info@Flighttripcharge.com">
                              info@Flighttripcharge.com
                            </a>
                            .
                          </div>
                          <p className="ptb-1">
                      ...
                      >
                        ...
                        >
                          <p>
                            ...
                            report to{" "}
                            <a
                              href="mailto:info@Flighttripcharge.com"
                              className="brb-link"
                            >
                              info@Flighttripcharge.com
                            </a>{" "}
                  ...
                  <div className="cm-tnc-section">
                    ...
                    <div className="tnc-section">
                      ...
                      <label for="ho">
                        ...
                        the following Policies of <strong>Flighttripcharge.com</strong>.
                      </label>
                    </div>
                  </div>
                </div>
