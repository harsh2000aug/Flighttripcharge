...
const RefundPolicyPage = () => {
  ...
  return (
    <div className="cm-legal-content-container">
      <Helmet>
        <title>Flighttripcharge | Refund & Cancellation</title>
      </Helmet>
      ...
      <div className="cm-section  cm-page-center cm-lr-pad">
        <ul>
          ...
          <li>
            All cancellations must be done over the phone only by calling <a href={`${window.location.origin}`}><b>Flighttripcharge.com</b></a> customer service at <a href="tel:+18774000302"> +1-877-400-0302</a>.
          </li>
          <li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                Apart from the suppliers' refund penalties, <a href={`${window.location.origin}`}><b>Flighttripcharge.com</b></a> will charge a post-ticketing services fee, as applicable.
              </li>
              <li>
          ...
          <li>
            ...
            <ul>
              <li>
                When a customer requests <a href={`${window.location.origin}`}><b>Flighttripcharge.com</b></a> to cancel a ticket booking, our agents will send the customer an email with a Unique Cancellation Password to the e-mail that was supplied when the booking was created.
              </li>
              <li>
